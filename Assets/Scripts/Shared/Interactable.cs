...
public class Interactable : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            UnityEngine.Debug.LogError("Interactable.cs requiere que un componente IInteractable est� en el mismo GameObject.", this);
            enabled = false;
        }
    ...
    {     
        if (other.CompareTag("Player"))   // Revisa si el objeto que entr� en el trigger es el jugador.
        {
            _playerInRange = true;
            if (_uiManager != null)
            {
