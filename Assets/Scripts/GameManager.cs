...
public class GameManager : MonoBehaviour
{
    ...
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        if (scene.name == "Mapa")
        {
            ...
            if (playerGo != null)
            {
                ...
                {
                    // No es necesario suscribirse aqu� si Health ya llama a OnPlayerDied.
                }
            }
        }
    ...
    // Este m�todo es llamado desde el script Health cuando el jugador muere.
    ...
    // M�todo p�blico para restablecer las vidas a su m�ximo.
